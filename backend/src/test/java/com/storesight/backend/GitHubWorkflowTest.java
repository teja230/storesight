...
/**
 * Simple test to verify that the GitHub workflow can run tests successfully.
 * This test uses the test profile which is configured to work with the
 * PostgreSQL and Redis services defined in the GitHub Actions workflow.
 */
@SpringBootTest
@ActiveProfiles("test")
